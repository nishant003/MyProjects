...
train-labaleled.txt is the labeled training data.
train-text.txt is the unlabeled training data.
train-key.txt consists of review IDs and their labels from train-labaleled.txt

dev-text.txt is the development data.
dev-key.txt consists of review IDs from dev-text.txt and their labels
